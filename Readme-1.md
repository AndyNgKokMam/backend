...
This project make use of keyset pagination. Example Xendit API, https://developers.xendit.co/api-reference/?javascript#list-transactions

Keyset Pagination, get next page base on last id.

Offset Pagination, using offset and limit pagination method will have poor performance when database is large. When you have to offset large amount of records.
It will have data inconsistency problem when data is being added/deleted, which will occur in real-time system.
